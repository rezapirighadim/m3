...
<section id="main-container">
    ...
    <section id="left-navigation">
        ...
        <ul class="mainNav" id="mainNav">
            ...
            <li><a href="/admin/mqtt_messages"><i class="fa fa-bell"></i> <span>تاریخچه هشدار ها</span></a></li>
            <li><a href="/admin/mqtt_alerts"><i class="fa fa-database"></i> <span>داده های ورودی</span></a></li>
